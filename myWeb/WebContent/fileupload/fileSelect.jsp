...
확인 버튼을 눌러주세요.<br>입력이 완료되면 DONE 버튼을 눌러주세요.</font></div><br>
...
<tr bgcolor="#FFCC00">
	...
	<td width="10%"><input type="text" name="user" onkeyup="inputValue(this.form,user,frmName2,0)" value="<%=getParam(request, "user")%>"> </td>
...
<tr>
	<td colspan="4"><div align="center"><font size="-2">추가할 파일 수 입력</font><input type="text" name="addcnt"><input type="button" value="확인" onclick="addFile(this.form)"></div></td>
</tr>
 </table>
</form>
<form enctype="multipart/form-data" name="frmName2" method="post">
<table width="75%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#660000" bgcolor="#FFFF99">
<tr bgcolor="#FFCC00"> 
	<td width="40%"><input type="hidden" name="txtUser" value="<%=getParam(request, "user")%>"> </td>
	<td width="40%"><input type="hidden" name="txtTitle" value="<%=getParam(request, "title")%>"> </td>
	<td width="40%"><input type="hidden" name="txtAbstract" value="<%=getParam(request, "abstract")%>">
