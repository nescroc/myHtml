		...
		<form>
			<table width="500" border="1" cellspacing="0" cellpadding="0"
				...
				<tr height="30">
					...
					<td align="center" width="125" bgcolor="${value_c }">${article.readcount}</td>
				</tr>
				<tr height="30">
				...
				<tr height="30">
					<td colspan="4" bgcolor="${value_c }" align="center">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" value="답글쓰기" onclick="document.location.href='/myWeb/board/writeForm.do?num=${article.num}&ref=${article.ref}&step=${article.step }&dpeth=${article.depth}'">
						&nbsp;&nbsp;&nbsp;&nbsp;
