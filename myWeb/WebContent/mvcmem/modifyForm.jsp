...
<form method="post" action="member.mdo?cmd=modifyProc" name="regForm">
	<table border="1">
		...
		<td><input type="hidden" name="id" value="${id }"><c:out value="${id}"/></td></tr>
		
		<tr><td align="right">패스워드 :</td>
		<td><input type="password" name="pass" value="${pass }"><c:out value="${pass}"/></td></tr>
		<tr><td align="right">패스워드 :</td>
		<td><input type="password" name="repass" value="${pass }"><c:out value="${pass}"/></td></tr>
		
		<tr><td align="right">이름:</td>
		<td><input type="hidden" name="name" value="${name}"><c:out value="${name}"/></td></tr>
